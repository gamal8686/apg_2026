...
ThemeData getThemeDataLight() {
  return  ThemeData(
    ...
    appBarTheme: AppBarTheme(backgroundColor: AppColorThemeLight.appBarThemeColor),
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: AppColorThemeLight.textButtonThemeColor),
    ),

    cardColor: AppColorThemeLight.cardColor.withValues(alpha: .50),
    inputDecorationTheme: InputDecorationTheme(
      fillColor: AppColorThemeLight.inputDecorationThemeColor.withValues(alpha: .40),
      enabledBorder: OutlineInputBorder(

        borderRadius: BorderRadius.circular(8.r),
        borderSide: BorderSide(
          color: AppColorThemeLight.inputDecorationThemeBorderRadiusColor.withValues(alpha: 0.040),
        ),
      ),
    ),
